...
|---|---|
| `core/approvals` | `core/access`, `core/jobs`, `core/rich-cards`, `modules/notifications` |
...
| `modules/contacts` | `core/access`, `modules/notifications` |
| `modules/counterparties` | `core/chatter`, `core/rich-cards`, `core/roles`, `core/search`, `core/templates` |
| `modules/documents` | `core/access`, `core/approvals`, `core/chatter`, `core/docs`, `core/files`, `core/jobs`, `core/rich-cards`, `core/roles`, `core/search`, `core/share-links`, `core/sign`, `core/templates`, `core/verify`, `modules/counterparties`, `modules/drive`, `modules/hr (токен)`, `modules/notifications`, `modules/processes (токен)`, `modules/staff` |
| `modules/drive` | `core/access`, `core/chatter`, `core/files`, `core/jobs`, `core/quick-actions`, `core/rich-cards`, `core/roles`, `core/search`, `core/share-links`, `modules/contacts`, `modules/notifications` |
| `modules/finances` | `core/access`, `core/quick-actions`, `core/rich-cards`, `modules/calendar`, `modules/contacts`, `modules/notifications` |
| `modules/hr` | `core/chatter`, `core/files`, `core/jobs`, `core/roles`, `core/sign`, `core/templates`, `modules/documents`, `modules/notifications`, `modules/processes`, `modules/staff`, `modules/tasks`, `modules/workspaces` |
...
| `modules/processes` | `core/approvals`, `core/chatter`, `core/rich-cards (токен)`, `core/roles`, `modules/documents (токен)`, `modules/finances (токен)`, `modules/hr (токен)`, `modules/messenger (токен)`, `modules/notifications`, `modules/staff (токен)`, `modules/tasks`, `modules/workspaces (токен)` |
...
| `modules/staff` | `core/access`, `core/chatter`, `core/roles`, `core/templates`, `modules/notifications` |
...
| `modules/workspaces` | `core/approvals`, `core/chatter`, `core/files`, `core/roles`, `core/share-links`, `core/templates`, `modules/notifications`, `modules/office (токен)`, `modules/staff`, `modules/wallet` |
