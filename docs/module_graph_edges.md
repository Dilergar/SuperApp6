...
| `core/share-links` | `core/analytics`, `core/audit`, `core/chatter`, `core/consents`, `core/idempotency`, `core/keys`, `core/notifications`, `core/verify` |
...
| `core/users` | `core/access`, `core/analytics`, `core/audit`, `core/consents`, `core/entitlements`, `core/files`, `core/jobs`, `core/keys`, `core/notifications`, `core/platform`, `core/verify`, `core/visibility`, `modules/contacts`, `modules/workspaces` |
...
| `modules/drive` | `core/access`, `core/audiences`, `core/audit`, `core/chatter`, `core/files`, `core/jobs`, `core/notifications`, `core/quick-actions`, `core/rich-cards`, `core/roles`, `core/search`, `core/share-links`, `modules/contacts`, `modules/workspaces` |
...
| `modules/messenger` | `core/access`, `core/analytics`, `core/calls`, `core/chatter`, `core/files`, `core/jobs`, `core/notifications`, `core/quick-actions`, `core/realtime`, `core/rich-cards`, `core/search`, `core/visibility`, `modules/calendar (токен)`, `modules/contacts`, `modules/drive` |
| `modules/notes` | `core/access`, `core/audiences`, `core/audit`, `core/chatter`, `core/files`, `core/jobs`, `core/notifications`, `core/quick-actions`, `core/rich-cards`, `core/roles`, `core/search`, `modules/contacts`, `modules/drive`, `modules/messenger`, `modules/workspaces` |
...
| `modules/workspaces` | `core/analytics`, `core/approvals`, `core/audit`, `core/chatter`, `core/consents`, `core/docs`, `core/entitlements`, `core/files`, `core/keys`, `core/notifications`, `core/platform`, `core/realtime`, `core/roles`, `core/share-links`, `core/sign`, `core/templates`, `core/users`, `core/visibility`, `core/webhooks`, `modules/hr (токен)`, `modules/office (токен)`, `modules/staff`, `modules/wallet` |
