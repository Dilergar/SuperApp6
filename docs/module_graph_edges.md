...
| `core/users` | `core/access`, `core/analytics`, `core/audit`, `core/consents`, `core/entitlements`, `core/files`, `core/jobs`, `core/keys`, `core/notifications`, `core/platform`, `core/verify`, `modules/contacts`, `modules/workspaces` |
...
| `modules/hr` | `core/audiences`, `core/audit`, `core/chatter`, `core/files`, `core/jobs`, `core/keys`, `core/notifications`, `core/roles`, `core/sign`, `core/templates`, `modules/documents`, `modules/processes`, `modules/staff`, `modules/tasks`, `modules/workspaces` |
...
| `modules/notes` | `core/access`, `core/audiences`, `core/chatter`, `core/files`, `core/jobs`, `core/notifications`, `core/quick-actions`, `core/rich-cards`, `core/roles`, `core/search`, `modules/contacts`, `modules/drive`, `modules/messenger`, `modules/workspaces` |
...
| `modules/workspaces` | `core/analytics`, `core/approvals`, `core/audit`, `core/chatter`, `core/consents`, `core/docs`, `core/entitlements`, `core/files`, `core/keys`, `core/notifications`, `core/platform`, `core/realtime`, `core/roles`, `core/share-links`, `core/sign`, `core/templates`, `core/webhooks`, `modules/hr (токен)`, `modules/office (токен)`, `modules/staff`, `modules/wallet` |
