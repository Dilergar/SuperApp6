...
import { Alert, Button, Chip, DatePicker, Input, LoadingBlock, Select } from '@/components/ui';
...
/** Вкладка «Команды»: журнал команд Кабинета — фильтры (сотрудник, команда, цель, период, исход), плотная таблица с курсорной подгрузкой, раскрытие строки. */
export function CommandsTab() {
  ...
  return (
    <>
      <p className="label-sm" style={{ margin: '0 0 var(--spacing-3)' }}>{t('audit.description')}</p>
