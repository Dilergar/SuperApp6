// Серверная обёртка: каталоги Заметок организации.
...
export default function WorkspaceNotesLayout({ children }: { children: ReactNode }) {
  return <ServiceMessages ns={['notes', 'circles']}>{children}</ServiceMessages>;
}
