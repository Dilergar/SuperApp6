...
/**
 * Внутренность глобального слушателя звонков. Вынесена в отдельный файл и
 * грузится через next/dynamic из CallsWatcher: иначе socket.io-client и весь
 * messenger-api ехали бы в корневой граф КАЖДОЙ страницы приложения.
 *
