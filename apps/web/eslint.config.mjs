    ...
    rules: {
      ...
      'i18n/no-cyrillic-literal': [
        'error',
        {
          ...
          // Свёртка букв алфавита для поиска значка («ё» → «е»): это ДАННЫЕ, а не
          // фраза, — переводить их некуда, а без свёртки поиск теряет половину слов.
          allowIdentifiers: ['CYRILLIC_FOLD'],
        },
      ],
    },
  },
