...
/**
 * Русское склонение по числу: `pluralRu(2, ['товар','товара','товаров'])` → «товара».
 * Формы в порядке: 1 / 2–4 / 5+ (11–14 всегда третья).
 */
...
/**
 * «90 дней» / «21 день» / «2 дня» — русское склонение. Одна реализация на API и веб:
 * шаблонизатор уведомлений склонять не умеет, а «осталось 1 дней» читается как баг.
 */
