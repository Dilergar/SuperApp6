...
export const DOCS_LIMITS = {
  /**
   * Закрытый документ (`archive` — единственная точка конца жизни) живёт столько дней:
   * окно, в котором хвосты ещё видны расследованию; дальше строка и неподписанные вехи
   * уходят шагом `docs.trash` раннера сроков core/lifecycle. С подписанной вехой — никогда.
   */
