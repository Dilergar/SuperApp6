...
> **Все фазы мессенджера в скоупе (1–7) завершены** (решение 2026-06-01: делаем только 6 и 7; ~~8 Центр уведомлений~~/~~9 вложения~~/~~10 mobile~~ — вне хвоста мессенджера). Дальше — **полная чистка кодовой базы**. Грилл был перед каждой фазой.
